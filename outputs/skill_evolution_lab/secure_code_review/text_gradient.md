...
- `rejected::config_security_001__v3_candidate_001`: configuration realization can regress to capability presence without explicit evidence realization
- `rejected::clean_false_positive_guard__v3_candidate_002`: false-positive control must remain zero on clean out-of-scope tasks
- `rejected::dependency_version_risk__v3_candidate_003`: dependency/version risk is unsupported and must remain outside secure_code_review core capability
