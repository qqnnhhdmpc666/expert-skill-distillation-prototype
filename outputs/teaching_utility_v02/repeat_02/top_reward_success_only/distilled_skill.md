...
- [C005] Runtime resource limits: Deployed services should define CPU and memory requests or limits.
...
- seed::case004_validation_sensitive_idempotency: case004_validation_sensitive_idempotency: do not miss R006 when the visible case text exposes those triggers; repair the review checklist before adding broader findings.
- seed::case002_resource_and_audit: case002_resource_and_audit: do not miss C005, C006 when the visible case text exposes those triggers; repair the review checklist before adding broader findings.
- query::case005_response_contract_schema: case005_response_contract_schema: do not miss R005 when the visible case text exposes those triggers; repair the review checklist before adding broader findings.
