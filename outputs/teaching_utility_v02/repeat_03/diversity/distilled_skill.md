...
- seed::case005_response_contract_schema: case005_response_contract_schema: do not miss R005 when the visible case text exposes those triggers; repair the review checklist before adding broader findings.
- seed::case003_clean_control: case003_clean_control: when visible evidence matches no rule, emit grounded findings only and preserve the output contract.
- query::case004_secret_and_resource: case004_secret_and_resource: do not miss C005 when the visible case text exposes those triggers; repair the review checklist before adding broader findings.
