...
- query::case006_clean_false_positive_control: case006_clean_false_positive_control: when visible evidence matches no rule, emit grounded findings only and preserve the output contract.
