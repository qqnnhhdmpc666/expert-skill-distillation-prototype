...
- query::case002_resource_and_audit: case002_resource_and_audit: do not miss C005 when the visible case text exposes those triggers; repair the review checklist before adding broader findings.
