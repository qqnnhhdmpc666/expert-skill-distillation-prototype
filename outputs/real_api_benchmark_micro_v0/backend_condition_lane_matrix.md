...
| --- | --- | --- | --- | ---: | ---: | --- | --- |
| `document_to_agent_real_api` | `mini_swe_agent_real_llm` | `no_skill` | `executed` | 1 | 0 | `True` | real DeepSeek-backed mini-SWE-agent row with local domain verifier |
| `document_to_agent_real_api` | `mini_swe_agent_real_llm` | `document_to_agent_bundle` | `executed` | 1 | 1 | `True` | real DeepSeek-backed mini-SWE-agent row with local domain verifier |
