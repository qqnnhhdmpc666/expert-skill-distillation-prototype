...
- [R005] Check consistent envelope fields: code, message, request_id, and data. Status: supported. execution-critical
- [R006] Check whether mutation endpoints document idempotency or duplicate submission handling. Status: supported. execution-critical
