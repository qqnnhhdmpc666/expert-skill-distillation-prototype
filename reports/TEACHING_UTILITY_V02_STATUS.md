...
Generated at: `2026-06-13T16:32:17.892826+00:00`
...
|---|---:|---:|---:|---:|
| random | 0.5 | 0.0 | 0.0 | 0 / 6 |
| top_reward_success_only | 0.3333 | 0.0 | 0.0 | 0 / 6 |
| success_failure_contrast | 0.3333 | 0.0 | 0.0 | 0 / 6 |
| diversity | 0.1667 | 0.0 | 0.0 | 0 / 6 |
| active_discriminative_evidence | 0.5 | 0.0 | 0.0 | 0 / 6 |

## Key Judgment

- `task_utility_vs_teaching_utility`: `task_utility_not_predictive_in_this_sealed_run`
- `active_selection_hypothesis`: `inconclusive`
- `best_method_by_hidden_delta`: `random`
