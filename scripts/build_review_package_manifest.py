...
KEY_ARTIFACTS = [
    ...
    ("outputs/external_security_mini_suite/rerun_stability/latest_rerun_stability_summary.json", "fresh_run", "python scripts/run_mini_suite_rerun_stability.py"),
    ("reports/MINI_SUITE_RERUN_STABILITY_STATUS.md", "derived_summary", "python scripts/run_mini_suite_rerun_stability.py"),
    ("outputs/skill_evolution_lab/secure_code_review/evolution_summary.json", "fresh_run", "skill-deploy evolve"),
    ("reports/SMALL_CANDIDATE_EVOLUTION_STATUS.md", "derived_summary", "skill-deploy evolve"),
    ("reports/ORACLE_LEAKAGE_AUDIT.md", "derived_summary", "python scripts/audit_oracle_leakage.py"),
    ("reports/EVIDENCE_TYPE_CONSISTENCY_AUDIT.md", "derived_summary", "python scripts/audit_evidence_type_consistency.py"),
    ("reports/MULTI_SKILL_ISOLATION_STATUS.md", "derived_summary", "python scripts/check_multi_skill_isolation.py"),
    ...
    ("reports/NON_ORACLE_DISCREPANCY_ANALYSIS.md", "derived_summary", "python scripts/analyze_non_oracle_discrepancy.py"),
    ("reports/non_oracle_discrepancy_analysis.json", "derived_summary", "python scripts/analyze_non_oracle_discrepancy.py"),
    ("outputs/non_oracle_validation_pre_p0_l_repair/non_oracle_validation_summary.json", "fresh_run", "pre-repair discrepancy evidence snapshot"),
    ...
    ("reports/IMPROVEMENT_DEMO_STATUS.md", "fresh_run", "skill-deploy improvement-demo"),
    ("outputs/skill_evolution_lab/secure_code_review/improvement_demo/improvement_demo_summary.json", "fresh_run", "skill-deploy improvement-demo"),
    ...
    ("reports/HOLDOUT_SECURITY_MINI_SUITE_STATUS.md", "fresh_run", "skill-deploy holdout-security-mini-suite"),
    ("outputs/external_security_mini_suite/holdout/holdout_summary.json", "fresh_run", "skill-deploy holdout-security-mini-suite"),
    ("reports/TASK_CONDITIONED_ACTIVATION_ABLATION_STATUS.md", "fresh_run", "skill-deploy activation-ablation"),
    ("outputs/ablation/task_conditioned_activation/activation_ablation_summary.json", "fresh_run", "skill-deploy activation-ablation"),
    ("reports/ADVANCED_CANDIDATE_EVOLUTION_STATUS.md", "fresh_run", "skill-deploy advanced-evolve"),
    ("outputs/skill_evolution_lab/secure_code_review/advanced_candidates/advanced_evolution_summary.json", "fresh_run", "skill-deploy advanced-evolve"),
    ("reports/QGSE_PARETO_MARGINAL_UTILITY_MECHANISM.md", "derived_summary", "skill-deploy advanced-evolve"),
    ...
    ("reports/OPEN_SOURCE_READINESS_AUDIT.md", "derived_summary", "skill-deploy open-source-readiness"),
    ...
    ("docs/ADDING_A_NEW_SKILL.md", "derived_summary", "manual prototype docs"),
    ("docs/RUNNING_VALIDATION.md", "derived_summary", "manual prototype docs"),
    ("docs/TROUBLESHOOTING.md", "derived_summary", "manual prototype docs"),
